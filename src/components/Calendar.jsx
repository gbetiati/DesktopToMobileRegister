const Calendar = () => {
  return (
    <div className="flex bg-whitesmoke shadow-md justify-start md:justify-center rounded-sm overflow-x-scroll mx-auto py-4 px-2  md:mx-12 mb-10">
      ...
      <div className="flex group hover:bg-purple-500 hover:shadow-lg hover-dark-shadow rounded-full mx-1 transition-all	duration-300	 cursor-pointer justify-center  w-16">
        <div className="flex items-center px-4 py-4">
          <div className="text-center">
            <p className="text-gray-900 group-hover:text-gray-100 text-sm transition-all font-normal group-hover:font-semibold	duration-300">
              {" "}
              Tue{" "}
            </p>
            <p className="text-gray-900 group-hover:text-gray-100 mt-3 group-hover:font-bold transition-all	duration-300">
      ...
      <div className="flex group bg-sky-700 shadow-lg dark-shadow rounded-full mx-1 cursor-pointer justify-center relative  w-12">
        ...
        <div className="flex items-center px-4 my-1 py-3">
          <div className="text-center">

  ...
  return (
    <div className="bg-zinc-50 mx-24 mt-20 p-12 shadow-md rounded-sm">
      <div className="overflow-x-auto">
        <div className="font font-semibold text-3xl mb-16 text-start"> Usuários do sistema</div>
        <div className="overflow-x-auto">
            ...
            <tbody>
              {userJsonData.map(({ name, email, user_id }) => (
                <tr>
                  <th>
                    <label>
                      <input type="checkbox" className="checkbox checkbox-sm" size={12} />
                    </label>
                  </th>
                  <td>
                  ...
                  <td>{user_id}</td>
                  <th>
                    <button className="btn btn-ghost btn-xs"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="20" viewBox="0 0 50 50">

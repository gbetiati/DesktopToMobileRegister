    ...
    <>
      <div className="bg-zinc-50 mx-24 mt-20 p-12 shadow-md rounded-sm">
        ...
        <div className="flex flex-row">
          ...
          <div className="basis-1/3"> Nome </div>
          <div className="basis-1/3"> ID </div>
          <div className="basis-1/3"> Excluir </div>
          <div className="basis-end"> Editar </div>
        </div>
        <ul>
          {shopsAllDocuments.map(({ description, _id }) => (
            <li key={nextId++}>
              ...
              <div className="flex flex-row mx-1">
                ...
                <div className="basis-1/3 text-sm mr-2">{description}</div>
                <div className="basis-1/3 text-sm mr-2">{_id}</div>
                ...
                <div className="basis-end mx-1">
                  <button className="btn btn-ghost btn-sm" onClick={null}>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="18"
                      height="18"
